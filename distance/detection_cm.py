...
def distance():
    face_cascade = cv2.CascadeClassifier(r'D:\code_thesis\save_eye_life\distance\haarcascade_frontalface_default.xml')
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            text3 = str(distance)
            # text2 = "distance: " + text3 + ' cm'
            # cv2.putText(img, text2, (x, y+h+20), font, np.float(0.6), (255, 255, 255), 1)

            # # text
            pathfont = "Prompt-Regular.ttf"
            roi = (x, y+h+10)
            img = text(img, roi, pathfont, str("distance: {} cm".format(text3)), 20, (0, 255, 0))
